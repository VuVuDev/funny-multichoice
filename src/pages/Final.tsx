    ...
    return (
        <div className='w-screen h-screen flex items-center justify-center'>
            <div className='w-[960px] sm:h-[520px] h-[720px] bg-[#ffffffc9] rounded-lg z-10 m-3'>
               <Topbar></Topbar>
               <div>
                    <div className='flex flex-col justify-center items-center sm:mt-[100px] mt-[180px]'>
                        <h1 className='font-mono font-extrabold text-[50px]'> MATCH {matchCount}</h1>
                        <h1 className='font-mono font-extrabold text-[40px] px-4 text-center'>{final.trimEnd() !== "This game is drawn!" ? <div className='flex flex-col justify-center items-center'>WINER: <span className='font-mono'>{final} 🥳</span></div> : ""}</h1>
                    </div>
